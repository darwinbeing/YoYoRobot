...
const char * ASR_RES_PATH      = "fo|/home/corvin/Music/Robot/voice/bin/msc/res/asr/common.jet"; //离线语法识别资源路径
const char * GRM_BUILD_PATH    = "/home/corvin/Music/Robot/voice/bin/msc/res/asr/GrmBuilld"; //构建离线语法识别网络生成数据保存路径
const char * GRM_FILE          = "/home/corvin/Music/Robot/voice/call.bnf"; //构建离线识别语法网络所用的语法文件
const char * listened_file     = "/home/corvin/Music/Robot/voice/wav/ddhgdw.pcm";
...
int recode_asr(void *ptr)
{
    ...
    char *buffer;
    char *ptr_buffer;
    FILE *fp = fopen("/home/corvin/Music/Robot/voice/wav/listened.wav", "wb");
...
{
    const char *login_config    = "appid = 57207923"; //登录参数
    int ret                     = 0 ;
