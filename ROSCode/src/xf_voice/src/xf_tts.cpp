...
char path[] = "/home/corvin/Music/say.wav";
char playPath[] = "play /home/corvin/Music/say.wav";
...
int xf_tts(const char* text, const char *filename)
{
    ...
    const char* session_begin_params = "voice_name = xiaowanzi, text_encoding = utf8, sample_rate = 16000, speed = 70, volume = 80, pitch = 50, rdn = 0";
...
int main(int argc, char **argv)
{
    ...
    const char* text  = "语音合成模块启动成功！"; //need composed text
    xf_tts(text, filename);
    playVoice();

    ros::init(argc, argv, "xf_tts");
    ros::NodeHandle n;
    ros::Subscriber sub = n.subscribe("/voice/xf_tts", 10, xfcallback);
    ros::spin();
